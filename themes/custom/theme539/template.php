...
/**
 * @file
 * Contains theme override functions and preprocess functions for the theme539 theme.
 */
/**
 * Changes the default meta content-type tag to the shorter HTML5 version
 */
function theme539_html_head_alter(&$head_elements) {
 ...
 */
function theme539_preprocess_search_block_form(&$vars) {
 ...
 */
function theme539_preprocess_html(&$vars) {
  ...
  if ($vars['is_admin']) {
	...
	if (!$vars['is_front']) {
		...
		$vars['classes_array'][] = theme539_id_safe('page-'. $path);
		$vars['classes_array'][] = theme539_id_safe('section-'. $section);
...
function theme539_preprocess_page(&$vars) {
 ...
 */
function theme539_preprocess_node(&$vars) {
  // Striping class
...
function theme539_preprocess_block(&$vars, $hook) {
 ...
 */
function theme539_breadcrumb($vars) {
 ...
 */	
function theme539_id_safe($string) {
